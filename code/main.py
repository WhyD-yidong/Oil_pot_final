...
if __name__ == '__main__':
    ...
    parser.add_argument('--start_date', default='20210902')
    parser.add_argument('--end_date', default='20230901')
    ...
    num_steps = 1 if args.net in ['lstm', 'cnn'] else 1
    ...
    # 출력 경로 생성
    output_path = os.path.join(settings.BASE_DIR, 'test_output', output_name)
    ...
    value_network_path = os.path.join(settings.BASE_DIR, 'test_models', value_network_name)
    policy_network_path = os.path.join(settings.BASE_DIR, 'test_models', policy_network_name)
    ...
    from shalom.oil_pot_trade.learners import ReinforcementLearner, DQNLearner, \
